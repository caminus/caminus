...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'MinecraftGroup'
        db.create_table('minecraft_minecraftgroup', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('authGroup', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['auth.Group'], unique=True)),
            ('permissionList', self.gf('django.db.models.fields.TextField')()),
        ))
        db.send_create_signal('minecraft', ['MinecraftGroup'])


    def backwards(self, orm):
        
        # Deleting model 'MinecraftGroup'
        db.delete_table('minecraft_minecraftgroup')
    ...
    models = {
        ...
        'minecraft.minecraftgroup': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'permissionList': ('django.db.models.fields.TextField', [], {})
        },
