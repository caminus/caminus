...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Server.secret'
        db.add_column('minecraft_server', 'secret', self.gf('django.db.models.fields.CharField')(default=datetime.date(2012, 4, 2), max_length=100), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Server.secret'
        db.delete_column('minecraft_server', 'secret')
