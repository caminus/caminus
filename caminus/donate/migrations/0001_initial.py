...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('donate_donation', (
            ...
            ('transactionId', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True)),
    ...
    models = {
        ...
        'donate.donation': {
            ...
            'transactionId': ('django.db.models.fields.IntegerField', [], {'null': 'True', 'blank': 'True'}),
