...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'Ban'
        db.create_table('minecraft_ban', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('player', self.gf('django.db.models.fields.related.ForeignKey')(related_name='bans', to=orm['minecraft.MinecraftProfile'])),
            ('banner', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'])),
            ('start', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
            ('expiration', self.gf('django.db.models.fields.DateTimeField')(blank=True)),
            ('reason', self.gf('django.db.models.fields.TextField')()),
        ))
        db.send_create_signal('minecraft', ['Ban'])


    def backwards(self, orm):
        
        # Deleting model 'Ban'
        db.delete_table('minecraft_ban')
    ...
    models = {
        ...
        'minecraft.ban': {
            ...
            'expiration': ('django.db.models.fields.DateTimeField', [], {'blank': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
