...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Server.ruleset'
        db.add_column('minecraft_server', 'ruleset', self.gf('django.db.models.fields.TextField')(default=''), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Server.ruleset'
        db.delete_column('minecraft_server', 'ruleset')
